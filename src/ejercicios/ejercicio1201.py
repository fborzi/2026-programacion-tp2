...
print("La division del primer numero entre el segundo es:", nro1/nro2)
...
print("El valor absoluto del primer numero es:",nro1)
print("El valor absoluto del segundo numero es:",nro2)