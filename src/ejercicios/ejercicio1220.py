"""En este ejercicio perdiremos una cadena de caracteres para cifrarla por el metodo 'la cifra de cesar' en la cual mediante
un alfabeto y un numero de corrimiento de lugares cifraremos una frase"""
